 ...
 * @author 구본영
 */
public class Check_BlackList implements FileInterface{
    ...
    public void FRead() {
        try {
            File text = new File("C:\\DB\\blackList.txt");
    ...
    public void FWrite(String a) throws IOException {
        BufferedWriter BFW = new BufferedWriter(new FileWriter("C:\\DB\\blackList.txt", true));
    ...
    public void Split() {
        ...
        for (int i = 0; i < readinfo.size(); i++) {
            ...
            blacklistinfo.add(new SignUpdataInfo(str[0],str[1],str[2],str[3],str[4],str[5],str[6]));
        }
    }
    
    public ArrayList<SignUpdataInfo> returnBlackListInfo() throws IOException {
